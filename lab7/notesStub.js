...
function ajax(verb, url, operation, successCb, contentType, body) {
  // TODO: Declare xhr and set it to a new XMLHttpRequest object.

  // TODO: Call the open method on xhr, passing it verb and url.

  if (successCb) successCb = successCb.bind(null, xhr);

  xhr.onreadystatechange = function () {
    // TODO: If the readyState property of xhr is not 4, return.
  ...
  // TODO: If a contentType was specified,
  // TODO: set the 'Content-Type' request header to it.

  // TODO: Send an HTTP request with the specified body.
}
